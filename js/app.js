/* =========================================================
   app.js — final + stagger per-karakter hero
   ========================================================= */
   ...
   function initEfek() {
     ...
     try {
       ...
       // BARU: judul hero naik per-huruf
       if (document.querySelector('#hero .huruf')) {
         gsap.from('#hero .huruf', {
           yPercent: 120, opacity: 0, stagger: .03, duration: .9,
           ease: 'power4.out', delay: .1
         });
       }
   
       // Line-mask reveal judul section
       ...
       // Etalase fasilitas: pin + stagger + skew
