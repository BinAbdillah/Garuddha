/* =========================================================
   utils.js — pembantu umum + judul editorial ber-masker
   ========================================================= */
   ...
   /* Judul editorial: nomor + garis + judul raksasa dalam MASKER
      (mask-line dianimasikan GSAP; tanpa GSAP teks tetap terbaca) */
   const judulSeksi = (nomor, judul, sub) => `
     <div class="reveal mb-10 md:mb-14">
       ...
       <h2 class="mt-4 text-4xl font-extrabold uppercase tracking-tight text-slate-900 md:text-5xl">
